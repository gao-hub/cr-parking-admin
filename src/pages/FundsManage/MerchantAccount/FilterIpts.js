...
@connect(({ merchantAccountManage, loading }) => ({
  ...
  loading:
    loading.effects['merchantAccountManage/fetchList'] || loading.effects['merchantAccountManage/statusChangeManage'] || loading.effects['merchantAccountManage/downloadMember'],
}))
...
export default class FilterIpts extends Component {
  formSubmit = async (e) => {
    await this.props.dispatch({
      type: 'merchantAccountManage/setSearchInfo',
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'merchantAccountManage/initSelect',
      payload: {}
    })
  }
        ...
        <div className={tableStyles.tableListForm}>
          <Form>
            <Row gutter={24} type="flex">
              <Col {...inputConfig}>
                <FormItem label="子账户名称" {...formItemConfig}>
              ...
              <Col {...inputConfig}>
                <FormItem label="子账户代号" {...formItemConfig}>
