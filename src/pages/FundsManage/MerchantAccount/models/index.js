...
export default {
  namespace: 'merchantAccountManage',
  ...
  effects: {
    ...
    *asyncData({ payload }, { call }) {
    ...
    // 提现提交
    *withdrawSubmit({ payload }, { call }) {
      return yield call(api.withdrawSubmit, payload);
    },
    // 划拨提交
    *transferSubmit({ payload }, { call }) {
      return yield call(api.asyncData, payload);
    },
    ...
    *rechargeInfo({ payload }, { call }) {
    ...
    // 提现初始化
    *withdrawInfo({ payload }, { call }) {
      return yield call(api.withdrawInfoData, payload);
    },
  },
