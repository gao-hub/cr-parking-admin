...
const defcolumns = [
  ...
  },
  {
    ...
    render: record => (record === 0 ? '收入' : record === 1 ? '支出' : ''),
  },
  // {
  //   title: '楼盘名称',
...
@permission
@connect(({ userAccountDetailInfoManage, loading }) => ({
  userAccountDetailInfoManage,
  loading:
    loading.effects['userAccountDetailInfoManage/fetchList'] ||
    loading.effects['userAccountDetailInfoManage/getModifyInfo'],
  exportLoading: loading.effects['userAccountDetailInfoManage/exportExcel'],
}))
export default class template extends PureComponent {
  ...
  getList = async (currPage, pageSize) => {
    ...
    this.props.dispatch({
      type: 'userAccountDetailInfoManage/fetchList',
      payload: {
        currPage,
        pageSize,
        ...this.props.userAccountDetailInfoManage.searchInfo,
      },
    });
  };
  renderBtn = () => {
  ...
  render() {
    const {
      permission,
      userAccountDetailInfoManage: { list },
    } = this.props;
    ...
    return (
      <PageHeaderWrapper renderBtn={this.renderBtn}>
        {permission.includes('chuangrong:userAccountDetailInfo:view') ? (
          <Card bordered={false}>
            <FilterIpts
              ...
              pageSize={pageSize}
            />
            {permission.includes('chuangrong:userAccountDetailInfo:list') ? (
