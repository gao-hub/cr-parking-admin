...
@connect(({ userAccountDetailInfoManage }) => ({
...
export default class FilterIpts extends Component {
  formSubmit = async e => {
    await this.props.dispatch({
      type: 'userAccountDetailInfoManage/setSearchInfo',
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'userAccountDetailInfoManage/initSelect',
      payload: {},
    });
  }
  ...
  render() {
    ...
    const {
      initData: { auditStatus, tradeStatus, verifyStatus, utmTypes, parentUtmTypes },
    } = this.props.userAccountDetailInfoManage;
    return (
        ...
        <div className={tableStyles.tableListForm}>
          <Form>
            <Row gutter={24} type="flex">
              ...
              <Col {...inputConfig}>
                <FormItem label="交易子类型" {...formItemConfig}>
                  {getFieldDecorator('subTradeType')(
                    <Select allowClear>
                      {auditStatus &&
