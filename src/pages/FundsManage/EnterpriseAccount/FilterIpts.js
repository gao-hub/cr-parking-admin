...
@connect(({ enterpriseAccountManage, loading }) => ({
  ...
  loading:
    loading.effects['enterpriseAccountManage/fetchList'] || loading.effects['enterpriseAccountManage/statusChangeManage'] || loading.effects['enterpriseAccountManage/downloadMember'],
}))
...
export default class FilterIpts extends Component {
  formSubmit = async (e) => {
    await this.props.dispatch({
      type: 'enterpriseAccountManage/setSearchInfo',
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'enterpriseAccountManage/initSelect',
      payload: {}
    })
  }
        ...
        <div className={tableStyles.tableListForm}>
          <Form>
            <Row gutter={24} type="flex">
              ...
              <Col {...inputConfig}>
                <FormItem label="ACCP用户编号" {...formItemConfig}>
                  {getFieldDecorator('oidUserno')(
                    <Input />
                  )}
                </FormItem>
              </Col>
