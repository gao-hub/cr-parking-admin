...
@Form.create()
export default class TabFilterIpts extends Component {
  state = {
    stateRadio: [
      {
        key: '1',
  ...
  getFormValue = () => {
    ...
    if (formQueryData.dueTime && formQueryData.dueTime.length) {
      formQueryData.updateTimeStart = moment(formQueryData.dueTime[0]).format('YYYY-MM-DD');
      formQueryData.updateTimeEnd = moment(formQueryData.dueTime[1]).format('YYYY-MM-DD');
        ...
        <div className={tableStyles.tableListForm}>
          <Form>
            <Row gutter={24} type="flex">
              ...
              <Col {...inputConfig}>
                <FormItem label="修改时间" {...formItemConfig}>
                  {getFieldDecorator('dueTime')(<RangePicker />)}
                </FormItem>
              </Col>
              <Col {...searchConfig}>
