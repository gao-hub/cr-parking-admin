...
export default class Modify extends PureComponent {
  ...
  handleOk = async () => {
    const {
      dispatch,
      form,
      parkingTransferManage: { modifyInfoData },
    } = this.props;
    ...
    return (
      ...
      >
        <Form>
          ...
          <FormItem label="车位编号" {...formConfig}>
          ...
          <FormItem label="实际售价" {...formConfig} required>
            {getFieldDecorator('actualPrice', {
              ...
              // initialValue: modifyInfoData && modifyInfoData.actualPrice,
            })(<Input maxLength={8} />)}
          </FormItem>
