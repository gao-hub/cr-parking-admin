    ...
    return (
      ...
      >
        <Form>
          ...
          <FormItem label="新推荐人" required={!dataInfo.spreadsUserName} {...formConfig}>
            {getFieldDecorator('spreadsUsername', {
              rules: [
                { required: !dataInfo.spreadsUserName, message: '请输入推荐人用户名' },
                {
                  validator: (rule, value) => {
                    if (!value || dataInfo.username !== value) {
                      return Promise.resolve();
                    }
                    return Promise.reject('推荐人不能是自己！');
                  },
                },
              ],
