...
export default class FilterIpts extends Component {
  formSubmit = async (e) => {
    await this.props.dispatch({
      type: 'redEnvelopes/setSearchInfo',
  ...
  getFormValue = () => {
    ...
    if (formQueryData.startTime && formQueryData.startTime.length) {
      formQueryData.activityTimeStart = moment(formQueryData.startTime[0]).format('YYYY-MM-DD 00:00:00')
      formQueryData.activityTimeEnd = moment(formQueryData.startTime[1]).format('YYYY-MM-DD 23:59:59')
    }
