...
export async function fetchList(params) {
  return request(`${_baseApi}/homeAdvert/list`, {
    method: 'POST',
    body: params,
  });
}
...
export async function addManage(params) {
  return request(`${_baseApi}/homeAdvert/add`, {
    method: 'POST',
    body: params,
  });
}
...
export async function modifyManage(params) {
  return request(`${_baseApi}/homeAdvert/update`, {
    method: 'POST',
    body: params,
  });
}
...
export async function deleteManage(params) {
  return request(`${_baseApi}/homeAdvert/delete`, {
    method: 'POST',
    body: params,
  });
}
...
export async function getModifyInfo(params) {
  return request(`${_baseApi}/homeAdvert/info`, {
    method: 'POST',
    body: params,
  });
}
...
export async function exportFile(params) {
  return exportExcel(`${_baseApi}/homeAdvert/export`, {
    method: 'POST',
    body: params,
  });
}
