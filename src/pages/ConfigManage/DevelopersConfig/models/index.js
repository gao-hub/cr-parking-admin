...
export default {
  ...
  effects: {
    ...
    *checkDeveloperName({ payload }, { call, }) {
      return yield call(api.checkDeveloperName, payload);
    },
    ...
    *getModifyInfo({ payload }, { call, put }) {
    ...
    //     启用/禁用
    *updateManage({ payload }, { call, put }) {
      return yield call(api.updateManage, payload);
    },
